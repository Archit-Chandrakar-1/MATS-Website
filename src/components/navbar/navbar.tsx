...
const Navbar: React.FC = () => {
  ...
  // All MATS Schools list (your exact list)
  const matsSchools = [
         ...
         {/* ABOUT */}
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-[220%] bg-white rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity z-30 py-2">
                {/* Overview & Leadership - Internal route */}
            ...
            {/* MATS SCHOOL - NO SCROLLING ON DESKTOP */}
            <div className="relative group">
              <button className="text-white hover:text-[#ffaf00] font-bold flex items-center">
              ...
              <div className="absolute left-0 mt-2 w-[220%] bg-white rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity z-30 py-2">
                {matsSchools.map((label, idx) => (
                  <a
                    key={idx}
                    href="#" // Replace with your routing logic later
                    className="block px-4 py-2 text-[#142143] hover:bg-[#ffaf00] hover:text-white font-semibold text-sm"
                  >
                    {label}
                  </a>
        ...
        {isMenuOpen && (
          <div className="lg:hidden pb-4 border-t border-[#ffaf00]/20">
            <nav className="flex flex-col space-y-3 pt-4">
              <button  onClick={() => navigate('/')}  className="text-white hover:text-[#ffaf00] font-bold text-left">Home</button>
      ...
      {[
        ...
        >
          {label}
              ...
              {/* Mobile MATS School - WITH SCROLLING ONLY ON MOBILE */}
              <div className="relative">
                <button
              ...
              <button onClick={() => navigate('/placement')} className="text-white hover:text-[#ffaf00] font-bold text-left">Placement</button>
