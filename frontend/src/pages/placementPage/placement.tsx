...
import { ArrowRight, Building, Users, Target, Globe, Award, Briefcase, X, Upload, User, Mail, Phone, BookOpen, GraduationCap } from 'lucide-react';
        ...
        <section className="bg-[#142143] text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <button
              ...
              className="bg-[#ffaf00] text-[#142143] px-8 py-4 rounded-full font-bold text-lg hover:bg-yellow-400 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
            ...
            <div className="mb-12">
              <div className="bg-[#ffaf00] rounded-2xl p-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-[#142143] mb-4">VISION STATEMENT OF T&P Cell</h3>
                    <p className="text-[#142143] leading-relaxed mb-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3">
                        <ArrowRight className="h-5 w-5 text-[#142143] mt-1 flex-shrink-0" />
                        <p className="text-[#142143]">
